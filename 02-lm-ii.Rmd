...
```{block2, exadddrop, type = 'rmdexercise'}
...
```{block, insdummy, type = 'rmdinsight'}
...
```{block2, instransf, type = 'rmdinsight'}
...
<!-- ```{block2, insmultico-3, type = 'rmdinsight'} -->
...
```{block2, exassump-4, type = 'rmdexercise'}
...
```{r, pol-2, echo = TRUE, collapse = TRUE, cache = TRUE}
...
```{block2, insortho, type = 'rmdinsight'}
...
```{r, int-3, echo = TRUE, collapse = TRUE, cache = TRUE, fig.asp = 1}
# 1. No dummy variable
...
```{r, int-5, echo = TRUE, collapse = TRUE, cache = TRUE, fig.asp = 1}
...
```{block, inssimpson, type = 'rmdinsight'}
...
```{block2, exharrison, type = 'rmdexercise'}
...
```{r, diag-1, collapse = TRUE, cache = TRUE, fig.asp = 1}
plot(mod, 1)
```
...
```{r, diag-2, collapse = TRUE, cache = TRUE, fig.asp = 1}
...
```{r, diag-3, collapse = TRUE, cache = TRUE, fig.asp = 1}
...
```{r, diag-4, collapse = TRUE, cache = TRUE, fig.asp = 1}
plot(mod, 2)
```
...
```{r, diag-6, collapse = TRUE, cache = TRUE, fig.asp = 1}
plot(mod, 3)
```
...
```{r, diag-8, collapse = TRUE, cache = TRUE, fig.asp = 1/2}
...
```{r, diag-9, collapse = TRUE, cache = TRUE, fig.asp = 1}
...
```{r, outl-1, collapse = TRUE, cache = TRUE, fig.asp = 1}
plot(mod, 5)
```
...
```{r, outl-2, collapse = TRUE, cache = TRUE, fig.asp = 1/2}
# Create data 
set.seed(12345)
x <- rnorm(100)
e <- rnorm(100, sd = 0.5)
