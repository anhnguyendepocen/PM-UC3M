...
\end{align}
The conditional log-odds \@ref(eq:eq-odds-log2) plays the role of the conditional mean for multiple linear regression. Therefore, we have an analogous interpretation for the coefficients:
