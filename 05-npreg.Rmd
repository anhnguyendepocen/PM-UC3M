...
\end{align}
Each evluation of $\hat m_{\ell}(x;h,p)$ in a different fit requires, thus, from a fit of the underlying logistic model.
...
\begin{align}
\mathrm{LCV}(h)=\sum_{i=1}^n\ell(Y_i,\hat\eta{-i}(X_i)),(\#eq:cvloclik)
\end{align}
